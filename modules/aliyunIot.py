...
class AliIot:
    ...
    def __init__(self, product_key=None, device_name=None, device_secret=None, product_secret=None,
                 server="iot-51z01dnf2huupes.mqtt.iothub.aliyuncs.com", qos=1):
    ...
    def connect(self):
        ...
        self.__server = aLiYun(self.__product_key, self.__product_secret, self.__device_name, self.__device_secret, "iot-51z01dnf2huupes.mqtt.iothub.aliyuncs.com")
